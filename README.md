<h1 align="center">COURTCAST</h1>

<p align="center"><strong>让每一次上场，都有自己的解说席</strong></p>

<p align="center">
上传一段 15–90 秒篮球视频，AI 自动完成回合理解、中文解说、真人感配音、现场声混音、字幕和 MP4 成片。
</p>

<p align="center">
  <a href="./docs/media/courtcast-demo.mp4">
    <img src="./docs/media/courtcast-demo-preview.gif" width="360" alt="CourtCast 篮球高光 AI 解说产品演示">
  </a>
  <br>
  <sub>▶ 点击动态预览，观看 36 秒完整产品演示</sub>
</p>

<p align="center">
  <a href="./docs/media/courtcast-demo.mp4">观看完整演示</a>
  ·
  <a href="#直接使用macos">开始制作</a>
  ·
  <a href="#测试">运行测试</a>
</p>
...
- 画面与解说按动作时间点对齐，避免球还没进就提前喊结果。
- 解说采用真实看球时的即时反应与篮球专业表达，不需要自己写稿或录音。
- 自动完成配音、现场声混音、字幕和成片，几分钟后即可分享。
- 支持填写球员姓名、球队、比分和专属音色，并可逐句矫正后重新生成。

## 四步完成一条篮球高光

1. **上传视频**：选择一段 15–90 秒篮球片段，横屏和竖屏均保留原始比例。
2. **理解回合**：AI 联合理解画面与现场声，定位突破、出手、命中、封盖和转换等事件。
3. **生成解说**：把专业解说、配音和字幕放回对应动作窗口，同时保留现场氛围。
4. **查看与矫正**：预览成片；不满意时逐句修改，再重新配音并导出 MP4。
